...
All notable changes to the AlphaAI project will be documented in this file.
...
This is a **major breaking update** that completely transforms AlphaAI from a static config-based system to a modern web-based trading platform.
...
- [GitHub Repository](https://github.com/gpteth/AlphaAI)
