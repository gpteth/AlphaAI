...
print_header() {
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
    echo -e "${PURPLE}  🤖 AlphaAI Trading Bot - PM2 Manager${NC}"
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
    echo ""
}
...
show_status() {
    ...
    echo ""
    print_info "详细信息:"
    pm2 info AlphaAI-backend
    echo ""
    pm2 info AlphaAI-frontend
}
...
show_logs() {
    if [ -z "$2" ]; then
        ...
        pm2 logs AlphaAI-backend
    elif [ "$2" = "frontend" ]; then
        pm2 logs AlphaAI-frontend
    else
