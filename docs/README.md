# 📚 AlphaAI Documentation Center / 文档中心

Welcome to the AlphaAI documentation! This page helps you find the right documentation quickly.

欢迎来到 AlphaAI 文档中心！本页面帮助您快速找到所需文档。

---

## 🚀 Getting Started / 快速开始

**New to AlphaAI? Start here!**
...
**Learn how to use AlphaAI effectively**
...
- 🐛 [Report Issues](https://github.com/gpteth/AlphaAI/issues)
...
**AlphaAI's strategic development plan and market expansion**
...
- 🐛 **Report a bug** → [GitHub Issues](https://github.com/gpteth/AlphaAI/issues/new)
- 💡 **Suggest a feature** → [Feature Request](https://github.com/gpteth/AlphaAI/issues/new?template=feature_request.md)
- 🔒 **Report security issue** → [Security Policy](../SECURITY.md)
- 💰 **Claim a bounty** → [Bounty Guide](community/bounty-guide.md)
- 🤝 **Contribute code** → [Contributing Guide](../CONTRIBUTING.md)
- 💬 **Ask questions** → [Telegram Community](https://t.me/AlphaAI88)
...
2. **Join Telegram** - [AlphaAI Developer Community](https://t.me/AlphaAI88)
3. **Create an Issue** - [New Issue](https://github.com/gpteth/AlphaAI/issues/new)
...
**Maintained by:** [Alan Community](https://github.com/Alan-community)
