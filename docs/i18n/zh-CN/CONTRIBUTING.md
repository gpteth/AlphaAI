...
感谢您有兴趣为 AlphaAI 做贡献！本文档提供了为项目做贡献的指南和工作流程。
...
1. 查看[悬赏 issue](https://github.com/gpteth/AlphaAI/labels/bounty)
2. 评论认领（先到先得）
3. 在截止日期前完成工作
4. 提交 PR 并填写悬赏认领部分
5. 合并后获得报酬
...
- **一般问题：** 加入我们的 [Telegram 社区](https://t.me/AlphaAI88)
- **技术问题：** 开启[讨论](https://github.com/gpteth/AlphaAI/discussions)
...
你的贡献让 AlphaAI 变得更好。我们感谢你的时间和努力！
