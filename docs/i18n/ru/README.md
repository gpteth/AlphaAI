...
**По вопросам инвестиций**, свяжитесь с основной командой через GitHub Discussions.

**По вопросам партнерства и сотрудничества**, создайте Issue на GitHub.
...
**💬 [Сообщество разработчиков AlphaAI](https://t.me/AlphaAI88)**
...
AlphaAI теперь поддерживает **три основные биржи**: Binance, Hyperliquid и Aster DEX!
...
Миссия AlphaAI - стать **Универсальной AI Торговой Операционной Системой** для всех финансовых рынков.
...
AlphaAI построен на современной модульной архитектуре:
...
**🎁 [Зарегистрироваться на Binance - Получить скидку](https://accounts.maxweb.red/register?ref=ALPHAAI)**
...
**AlphaAI также поддерживает Hyperliquid** - децентрализованную биржу бессрочных фьючерсов. Чтобы использовать Hyperliquid вместо Binance:
...
**AlphaAI также поддерживает Aster DEX** - децентрализованную биржу бессрочных фьючерсов, совместимую с Binance!
...
- **GitHub Issues**: [Создать Issue](https://github.com/gpteth/AlphaAI/issues)
