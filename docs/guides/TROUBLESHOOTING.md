...
1. ✅ **Backend is running**: `docker compose ps` or `ps aux | grep AlphaAI`
...
**Related Issue:** [#168](https://github.com/gpteth/AlphaAI/issues/168)
...
docker exec AlphaAI-backend date
...
**Related Issue:** [#60](https://github.com/gpteth/AlphaAI/issues/60)
...
**Manual/PM2:**
```bash
# Terminal where you ran ./AlphaAI shows logs

# PM2:
pm2 logs AlphaAI --lines 100

# Save to file
pm2 logs AlphaAI --lines 500 > backend_logs.txt
```
