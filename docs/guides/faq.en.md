...
### What is AlphaAI?
AlphaAI is an AI-powered cryptocurrency trading bot that uses large language models (LLMs) to make trading decisions on futures markets.
...
Yes! AlphaAI supports running multiple traders with different configurations, AI models, and trading strategies.
...
No! AlphaAI has a web UI for all configuration. However, basic command line knowledge helps with setup and troubleshooting.
...
**Recommended**: Yes, use a subaccount dedicated to AlphaAI for better risk isolation. However, note that some subaccounts have restrictions (e.g., 5x max leverage on Binance).
...
**Why**: AlphaAI uses `PositionSide(LONG/SHORT)` which requires Hedge Mode.

See [Issue #202](https://github.com/gpteth/AlphaAI/issues/202) and [Troubleshooting Guide](TROUBLESHOOTING.md#-only-opening-short-positions-issue-202).
...
Yes, to some extent. AlphaAI provides historical performance feedback in each decision prompt, allowing the AI to adjust its strategy.
...
2. Search [existing issues](https://github.com/gpteth/AlphaAI/issues)
3. If not found, use our [Bug Report Template](../../.github/ISSUE_TEMPLATE/bug_report.md)

### Where can I get help?
- [GitHub Discussions](https://github.com/gpteth/AlphaAI/discussions)
- [Telegram Community](https://t.me/AlphaAI88)
- [GitHub Issues](https://github.com/gpteth/AlphaAI/issues)

---

## Contributing

### Can I contribute to AlphaAI?
...
Open a [Feature Request](https://github.com/gpteth/AlphaAI/issues/new/choose) with your idea!
