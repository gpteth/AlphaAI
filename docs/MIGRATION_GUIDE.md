...
AlphaAI documentation has been reorganized into a structured `docs/` directory for better organization and navigation.
...
- Old: `github.com/Alan-community/AlphaAI/blob/main/DOCKER_DEPLOY.en.md`
...
3. Ask in [Telegram](https://t.me/AlphaAI88)

**Link broken?**
- Report in [GitHub Issues](https://github.com/gpteth/AlphaAI/issues)
- We'll fix it ASAP!
