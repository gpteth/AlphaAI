...
为希望了解 AlphaAI 内部实现的开发者提供的技术文档。

---

## 📋 概述

AlphaAI 是一个全栈 AI 交易平台：
- **后端：** Go (Gin 框架, SQLite)
...
- 查看[开放问题](https://github.com/gpteth/AlphaAI/issues)
- 加入 [Telegram 社区](https://t.me/AlphaAI88)

**需要澄清？**
- 开启 [GitHub 讨论](https://github.com/gpteth/AlphaAI/discussions)
- 在 Telegram 提问
