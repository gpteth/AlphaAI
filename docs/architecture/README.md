# 🏗️ AlphaAI Architecture Documentation

**Language:** [English](README.md) | [中文](README.zh-CN.md)

Technical documentation for developers who want to understand AlphaAI internals.

---

## 📋 Overview

AlphaAI is a full-stack AI trading platform with:
...
- Check [Open Issues](https://github.com/gpteth/AlphaAI/issues)
- Join [Telegram Community](https://t.me/AlphaAI88)

**Need clarification?**
- Open a [GitHub Discussion](https://github.com/gpteth/AlphaAI/discussions)
- Ask in Telegram
