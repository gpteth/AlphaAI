...
- **Alan** - [@LuoAlan2025](https://x.com/LuoAlan2025)

### 💼 Seed Funding Round Open

We are currently raising our **seed round**. 

**For investment inquiries**, please contact the core team via GitHub Discussions.

**For partnerships and collaborations**, please open an issue on GitHub.
...
**💬 [AlphaAI Developer Community](https://t.me/AlphaAI88)**
...
AlphaAI now supports **three major exchanges**: Binance, Hyperliquid, and Aster DEX!
...
AlphaAI is currently **fully operational in cryptocurrency markets** with the following proven capabilities:
...
AlphaAI is on a mission to become the **Universal AI Trading Operating System** for all financial markets.
...
AlphaAI is built with a modern, modular architecture:
...
**🎁 [Register Binance - Get Fee Discount](https://accounts.maxweb.red/register?ref=ALPHAAI)**
...
```bash
git clone https://github.com/gpteth/AlphaAI.git
cd AlphaAI
```
...
**AlphaAI also supports Hyperliquid** - a decentralized perpetual futures exchange. To use Hyperliquid instead of Binance:
...
**AlphaAI also supports Aster DEX** - a Binance-compatible decentralized perpetual futures exchange!
...
### 🐛 Technical Support
- **GitHub Issues**: [Submit an Issue](https://github.com/gpteth/AlphaAI/issues)
- **Developer Community**: [Telegram Group](https://t.me/AlphaAI88)
...
[![Star History Chart](https://api.star-history.com/svg?repos=Alan-community/AlphaAI&type=Date)](https://star-history.com/#Alan-community/AlphaAI&Date)
# AlphaAI
# AlphaAI
