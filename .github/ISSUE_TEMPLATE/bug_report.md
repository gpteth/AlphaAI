---
name: Bug Report
about: Report a bug to help us improve AlphaAI
title: '[BUG] '
labels: bug
assignees: ''
---
...
**Manual/PM2 users:**
```bash
# Terminal output where you ran: ./AlphaAI
# OR PM2 logs:
...
- **AlphaAI Version:** [run: `git log -1 --oneline` or check release tag]
...
9. ✅ Verify backend is running: `docker compose ps` or `ps aux | grep AlphaAI`
