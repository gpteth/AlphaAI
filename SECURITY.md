...
AlphaAI is an AI-powered trading system that handles real funds and API credentials. We take security seriously and appreciate the security community's efforts to responsibly disclose vulnerabilities.
...
If you discover a security vulnerability in AlphaAI, please **DO NOT**:
...
- **Alan:** [@LuoAlan2025 on Twitter](https://x.com/LuoAlan2025) (DM)
...
To keep your AlphaAI deployment secure:
...
chmod 600 AlphaAI.db
chmod 600 config.json

# ❌ DON'T: Leave files world-readable
chmod 777 AlphaAI.db  # NEVER DO THIS
```
...
# Watch GitHub releases: https://github.com/gpteth/AlphaAI/releases
```
...
- 🐦 **Twitter DM:** [@LuoAlan2025](https://x.com/LuoAlan2025)

**For general questions:**
- See [CONTRIBUTING.md](CONTRIBUTING.md)
- Join [Telegram Community](https://t.me/AlphaAI88)

---

**Thank you for helping keep AlphaAI secure!** 🔒
...
AlphaAI 是一个处理真实资金和 API 凭证的 AI 交易系统。我们非常重视安全，并感谢安全社区负责任地披露漏洞的努力。
...
直接联系核心团队：
- **Alan:** [@LuoAlan2025 on Twitter](https://x.com/LuoAlan2025)（私信）
...
# 订阅安全公告
# 关注 GitHub 发布：https://github.com/gpteth/AlphaAI/releases
```
...
**仅限安全问题：**
- 🐦 **Twitter 私信：** [@LuoAlan2025](https://x.com/LuoAlan2025)

**一般问题：**
- 加入 [Telegram 社区](https://t.me/AlphaAI88)
