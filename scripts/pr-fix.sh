...
echo ""
echo "╔═══════════════════════════════════════════╗"
echo "║  AlphaAI PR Migration Tool                   ║"
...
if ! git rev-parse --is-inside-work-tree > /dev/null 2>&1; then
    log_error "Not a git repository. Please run this from your AlphaAI fork."
    exit 1
fi
...
log_info "Telegram: https://t.me/AlphaAI88"

echo ""
log_success "Thank you for contributing to AlphaAI! 🚀"
echo ""
