...
export const translations = {
  en: {
    ...
    // Footer
    footerTitle: 'AlphaAI - AI Trading System',
    ...
    heroDescription: 'AlphaAI is the future standard for AI trading — an open, community-driven agentic trading OS. Supporting Binance, Aster DEX and other exchanges, self-hosted, multi-agent competition, let AI automatically make decisions, execute and optimize trades for you.',
    poweredBy: 'Powered by Aster DEX and Binance, strategically invested by Amber.ac.',
    
    // Landing Page CTA
    readyToDefine: 'Ready to define the future of AI trading?',
    startWithCrypto: 'Starting with crypto markets, expanding to TradFi. AlphaAI is the infrastructure of AgentFi.',
    getStartedNow: 'Get Started Now',
    viewSourceCode: 'View Source Code',
    
    // Features Section
    coreFeatures: 'Core Features',
    whyChooseAlphaAI: 'Why Choose AlphaAI?',
    ...
    // About Section
    aboutAlphaAI: 'About AlphaAI',
    whatIsAlphaAI: 'What is AlphaAI?',
    AlphaAINotAnotherBot: "alphaai is not another trading bot, but the 'Linux' of AI trading —",
    AlphaAIDescription1: 'a transparent, trustworthy open source OS that provides a unified',
    AlphaAIDescription2: "'decision-risk-execution' layer, supporting all asset classes.",
    AlphaAIDescription3: 'Starting with crypto markets (24/7, high volatility perfect testing ground), future expansion to stocks, futures, forex. Core: open architecture, AI',
    AlphaAIDescription4: 'Darwinism (multi-agent self-competition, strategy evolution), CodeFi',
    AlphaAIDescription5: 'flywheel (developers get point rewards for PR contributions).',
    ...
    howToStart: 'How to Get Started with AlphaAI',
    fourSimpleSteps: 'Four simple steps to start your AI automated trading journey',
    step1Title: 'Clone GitHub Repository',
    step1Desc: 'git clone https://github.com/gpteth/AlphaAI and switch to dev branch to test new features.',
    ...
    riskWarningText: 'Dev branch is unstable, do not use funds you cannot afford to lose. AlphaAI is non-custodial, no official strategies. Trading involves risks, invest carefully.',
    ...
    // Login Modal
    accessAlphaAIPlatform: 'Access AlphaAI Platform',
  ...
  zh: {
    ...
    heroTitle1: 'Read the Market.',
    heroTitle2: 'Write the Trade.',
    heroDescription: 'AlphaAI 是 AI 交易的未来标准——一个开放、社区驱动的代理式交易操作系统。支持 Binance、Aster DEX 等交易所，自托管、多代理竞争，让 AI 为你自动决策、执行和优化交易。',
    poweredBy: '由 Aster DEX 和 Binance 提供支持，Amber.ac 战略投资。',
    
    // Landing Page CTA
    readyToDefine: '准备好定义 AI 交易的未来吗？',
    startWithCrypto: '从加密市场起步，扩展到 TradFi。AlphaAI 是 AgentFi 的基础架构。',
    getStartedNow: '立即开始',
    viewSourceCode: '查看源码',
    
    // Features Section
    coreFeatures: '核心功能',
    whyChooseAlphaAI: '为什么选择 AlphaAI？',
    ...
    // About Section
    aboutAlphaAI: '关于 AlphaAI',
    whatIsAlphaAI: '什么是 AlphaAI？',
    AlphaAINotAnotherBot: 'AlphaAI 不是另一个交易机器人，而是 AI 交易的 \'Linux\' ——',
    AlphaAIDescription1: '一个透明、可信任的开源 OS，提供统一的 \'决策-风险-执行\'',
    AlphaAIDescription2: '层，支持所有资产类别。',
    AlphaAIDescription3: '从加密市场起步（24/7、高波动性完美测试场），未来扩展到股票、期货、外汇。核心：开放架构、AI',
    AlphaAIDescription4: '达尔文主义（多代理自竞争、策略进化）、CodeFi 飞轮（开发者 PR',
    AlphaAIDescription5: '贡献获积分奖励）。',
    ...
    // How It Works Section
    howToStart: '如何开始使用 AlphaAI',
    fourSimpleSteps: '四个简单步骤，开启 AI 自动交易之旅',
    step1Title: '拉取 GitHub 仓库',
    step1Desc: 'git clone https://github.com/gpteth/AlphaAI 并切换到 dev 分支测试新功能。',
    step2Title: '配置环境',
    ...
    riskWarningText: 'dev 分支不稳定，勿用无法承受损失的资金。AlphaAI 非托管，无官方策略。交易有风险，投资需谨慎。',
    ...
    // Login Modal
    accessAlphaAIPlatform: '访问 AlphaAI 平台',
