            ...
            <ul className='space-y-2 text-sm' style={{ color: '#848E9C' }}>
              <li>
                <a
                  ...
                  href='https://github.com/gpteth/AlphaAI'
                  target='_blank'
          ...
          <div>
            ...
            <ul className='space-y-2 text-sm' style={{ color: '#848E9C' }}>
              <li>
                <a
                  className='hover:text-[#F0B90B]'
                  href='https://github.com/gpteth/AlphaAI/blob/main/README.md'
                  target='_blank'
                  rel='noopener noreferrer'
                >
              ...
              <li>
                <a
                  className='hover:text-[#F0B90B]'
                  href='https://github.com/gpteth/AlphaAI/issues'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  Issues
              ...
              <li>
                <a
                  className='hover:text-[#F0B90B]'
                  href='https://github.com/gpteth/AlphaAI/pulls'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  Pull Requests
